...
- **[reassess](./reassess/SKILL.md)**: Reassess progress and working assumptions when local fixes stall or a long-running effort loses direction, then choose the next useful step.
- **[supervise](./supervise/SKILL.md)**: Coordinate a specific task or issue through completion with a dedicated desktop thread per delegated ticket, verifying results against the parent objective.
